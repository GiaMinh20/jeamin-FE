  ...
  useQuery(
    ...
    () =>
      mainOrder
        .getCountOrder({
          UID: userNew?.UserId,
          RoleID:
            userNew?.UserGroupId === 8 || userNew?.UserGroupId === 6
              ? 3
              : userNew?.UserGroupId,
        })
        .then((res) => {
        ...
        }),
    {
      enabled:
        ...
        userNew?.UserGroupId === 8 ||
        userNew?.UserGroupId === 6,
      retry: false,
    }
  );
          ...
          <div className={styles.img}>
            <Link href="/">
              <a className={clsx(styles.logo, "")}>
                <div className={`${styles.img} ${!hover && "w-[50px]"}`}>
                  <Image
                    src={"/default/default_favicon.png"}
                    width={"5rem"}
                    height={"100%"}
                    alt="logo"
                    preview={false}
                ...
                >
                  <Link href={"/user/info-users"}>
                    <a className="popover-a">
                      <span>
                        <i
                          className={clsx("fas fa-play !text-sec")}
                          style={{
                            fontSize: 10,
                            textAlign: "center",
                            padding: 0,
                  ...
                  <li key={name} className="w-fit p-4 font-bold text-base">
                    <Link href={path}>
                      <a className="popover-a">
                        ...
                        <span className="ml-4 !text-sec">{name}</span>
                      </a>
                    </Link>
                  </li>
                }
                  ...
                  >
                    <Link href={children.path}>
                      <a className="popover-a">
                        ...
                        <span className="ml-4 !text-sec">{children.name}</span>
                      </a>
                    </Link>
                  </li>
                ))}
