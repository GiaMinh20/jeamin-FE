    ...
    <>
      <header
        className={clsx(
          ...
          userPage !== true && "!fixed !h-[54px] shadow-xl",
          userPage && `xl:!w-[100%]`
        )}
      >
        <div className="flex">
          {!hover && (
            ...
            >
              <button
                className={clsx(styles.action, "text-sec")}
          ...
          <div className="sm:hidden xl:block relative mr-auto p-3">
            <Link href="/">
              <a className={clsx(styles.logo, "")}>
                <div className={`${styles.img} w-[25rem]`}>
                  <Image
        ...
        <ul className={`${styles.wrapper} grid-cols-3`}>
          ...
          <li className={`col-span-1 items-center xl:!flex ${styles.item}`}>
            ...
            >
              <span className="!mr-2 text-black text-sm font-normal">
                Tỉ giá
              </span>
          ...
          >
            <div
              className={clsx(
                styles.block,
                styles.actionInfo,
                "!flex items-center rounded-xl !px-2 !py-[4px] bg-sec shadow-xl"
              )}
            >
              {
                <span
                  className={`text-white font-semibold text-normal leading-[initial] text-[13px]`}
                >
          ...
          <li className={clsx(styles.item, "col-span-1 cursor-pointer mr-6")}>
            ...
            >
              ...
              {dataNewNotify > 0 && (
                <div
                  className={`text-[12px]  items-center flex bg-sec rounded-full absolute px-[10px] top-[50%] left-[50%] translate-y-[-90%]`}
                >
            ...
            <Drawer
              ...
              extra={
                ...
                >
                  <Tag color="magenta" onClick={() => setVisible(false)} className="cursor-pointer">
                      Tất cả thông báo!
                  </Tag>
                </Link>
              }
