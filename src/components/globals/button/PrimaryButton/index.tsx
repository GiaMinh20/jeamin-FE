...
export const Button: FC<TProps> = ({
	...
	return (
		<div
			className={clsx(
				'bg-gray relative min-w-[80px] px-4 py-2 mx-1 h-10 cursor-pointer text-center inline-flex items-center justify-center shadow-xl hover:shadow-none hover:translate-y-1 transition-all duration-500',
				btnClass
			)}
